...
public class CommercetoolsMenuChoiceController {
    ...
    public CommercetoolsMenuChoiceController() {
    }

    @AuthorizeJwtHeader
    @PostMapping(path = "/commercetools-menu", consumes = MediaType.APPLICATION_JSON_VALUE)
    @ResponseStatus(HttpStatus.NO_CONTENT)
    public void mention(@RequestBody @Nonnull final MessageSent messageSent) {
        LOGGER.info("Chose the commercetools menu controller", messageSent.getMessage().getText());
    }
